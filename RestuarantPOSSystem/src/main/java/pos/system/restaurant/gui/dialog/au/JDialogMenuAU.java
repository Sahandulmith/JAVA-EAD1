...
public class JDialogMenuAU extends javax.swing.JDialog {
    ...
    public JDialogMenuAU(JFrameHome jFrameHome, boolean modal) {
    ...
    public JDialogMenuAU(JFrameHome jFrameHome, boolean modal,Menu menu, String title) {
        super(jFrameHome, modal);
        initComponents();
        setTitle("UPDATE");
        this.menu = menu;
    ...
    public JDialogMenuAU(JFrameHome jFrameHome, boolean modal, String title, Menu menu) {
        super(jFrameHome, modal);
        initComponents();
        setTitle("DELETE");
        this.menu = menu;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (this.title.equals("New")) {
            int response = JOptionPane.showConfirmDialog(jFrameHome, "Are you sure to save " + jTextFieldRecipe.getText() + " " + jTextFieldPrice.getText() + " ?", "Save confirmation", JOptionPane.YES_NO_OPTION);
            ...
            int response = JOptionPane.showConfirmDialog(jFrameHome, "Are you sure to update " + jTextFieldRecipe.getText() + " " + jTextFieldPrice.getText() + " ?", "Save confirmation", JOptionPane.YES_NO_OPTION);
            if (response == JOptionPane.YES_OPTION) {
                this.menu.setRecipe(jTextFieldRecipe.getText());
                this.menu.setPrice(Float.parseFloat(jTextFieldPrice.getText()));
                this.menu.setIngredients(jTextAreaIngredients.getText());
            ...
            int response = JOptionPane.showConfirmDialog(jFrameHome, "Are you sure to delete " + jTextFieldRecipe.getText() + " " + jTextFieldPrice.getText() + " ?", "Save confirmation", JOptionPane.YES_NO_OPTION);
            if (response == JOptionPane.YES_OPTION) {
