...
public class JDialogChangePassword extends javax.swing.JDialog {
    ...
    private pos.system.restaurant.guii.JFrameHome jFrameHome;

    public JDialogChangePassword(pos.system.restaurant.guii.JFrameHome parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButtonChangePasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonChangePasswordActionPerformed
        ...
        if (response == JOptionPane.YES_OPTION) {
            if (userAccountDAOImpl.changePassword(userAccount) == true) {
                JOptionPane.showMessageDialog(jFrameHome, "Password is successfully change.", "Message", JOptionPane.PLAIN_MESSAGE);
                this.dispose();
            }
        }
