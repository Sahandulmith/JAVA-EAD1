...
public class JDialogCategoryAU extends javax.swing.JDialog {
    ...
    public JDialogCategoryAU(JFrameHome jFrameSariPOS, boolean modal) {
    ...
    public JDialogCategoryAU(JFrameHome jFrameHome, boolean modal, Category category, String title) {
    ...
    public JDialogCategoryAU(JFrameHome jFrameHome, boolean modal, String title, Category category) {
        super(jFrameHome, modal);
        initComponents();
        setTitle(title);
        this.category = category;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (this.title.equals("New")) {
            int response = JOptionPane.showConfirmDialog(jFrameHome, "Are you sure to save " + jTextFieldCategory.getText() + " ?", "Save confirmation", JOptionPane.YES_NO_OPTION);
            ...
            int response = JOptionPane.showConfirmDialog(jFrameHome, "Are you sure to update " + jTextFieldCategory.getText() + " ?", "Save confirmation", JOptionPane.YES_NO_OPTION);
            if (response == JOptionPane.YES_OPTION) {
                this.category.setCategory(jTextFieldCategory.getText());
                this.category.setDescription(jTextFieldDescription.getText());
                try {
            ...
            int response = JOptionPane.showConfirmDialog(jFrameHome, "Are you sure to delete " + jTextFieldCategory.getText() + " ?", "Save confirmation", JOptionPane.YES_NO_OPTION);
            if (response == JOptionPane.YES_OPTION) {
