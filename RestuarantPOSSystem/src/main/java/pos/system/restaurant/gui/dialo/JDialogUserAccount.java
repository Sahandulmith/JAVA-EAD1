...
import pos.system.restaurant.gui.dialog.au.JDialogUserAccountAU;
...
public class JDialogUserAccount extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogUserAccount(JFrameHome jFrameHome, boolean modal) {
    ...
    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        JDialogUserAccountAU roleAU = new JDialogUserAccountAU(jFrameHome, true);
        roleAU.setVisible(true);
        selectUserAccount();
    }//GEN-LAST:event_jButtonNewActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogUserAccountAU roleAU = new JDialogUserAccountAU(jFrameHome, true, userAccount, "Update");
        roleAU.setVisible(true);
        selectUserAccount();
        jButtonUpdate.setEnabled(false);
