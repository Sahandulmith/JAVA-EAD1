...
import pos.system.restaurant.util.EditPrice;
...
public class JDialogEditPrice extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogEditPrice(JFrameHome jFrameHome, boolean modal) {
...
//        saveTodaysMenu();
        JDialogUpdatePrice updatePrice = new JDialogUpdatePrice(jFrameHome, true, editPrice);
...
//        selectMenuOfTheDay();
    ...
    private void saveTodaysMenu() {
        ...
        if (response == JOptionPane.YES_OPTION) {
            ...
            JOptionPane.showMessageDialog(jFrameHome, "Menu of the day is successfully added to menu of the day.", "Message", JOptionPane.PLAIN_MESSAGE);
            this.dispose();
        }
    }
