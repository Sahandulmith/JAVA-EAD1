...
import pos.system.restaurant.dao.impl.CategoryDAOImpl;
import pos.system.restaurant.dao.impl.InvoiceDAOImpl;
import pos.system.restaurant.dao.impl.InvoiceLineMenuDAOImpl;
import pos.system.restaurant.dao.impl.MenuDAOImpl;
import pos.system.restaurant.dao.impl.TodaysMenuDAOImpl;
//import com.aldrin.cafsysv2.events.ActionListenerHandler;
import pos.system.restaurant.gui.dialo.JDialogAbout;
import pos.system.restaurant.gui.dialo.JDialogCategory;
import pos.system.restaurant.gui.dialo.JDialogChangePassword;
import pos.system.restaurant.gui.dialo.JDialogEditPrice;
import pos.system.restaurant.gui.dialo.JDialogMenu;
import pos.system.restaurant.gui.dialo.JDialogReport;
import pos.system.restaurant.gui.dialo.JDialogSale;
import pos.system.restaurant.gui.dialo.JDialogTodaysMenu;
import pos.system.restaurant.gui.dialo.JDialogUserAccount;
import pos.system.restaurant.gui.dialo.JDialogViewInvoice;
...
import pos.system.restaurant.util.OrdersHold;
...
import pos.system.restaurant.gui.dialo.JDialogRole;
import pos.system.restaurant.gui.dialog.au.JDialogRoleAU;
import pos.system.restaurant.gui.dialog.au.JDialogSendMessage;
import pos.system.restaurant.gui.dialog.au.JWebCamOpen;

@Setter
@Getter
@ToString
public class JFrameHome extends javax.swing.JFrame implements MouseListener {
    ...
    public JFrameHome(Category c, JFrameHome jFrameHome) {

        selectTodaysMenu(c.getId());

    }

    public JFrameHome(TodaysMenu tm) {
        addOrderToTable(tm);
    }
    ...
    private void initComponents() {
        ...
        jButtonTodaysMenu.setIcon(new FlatSVGIcon("svg/menu-list-checklist.svg",42,42));
        ...
        jButtonCustomeradd.setIcon(new FlatSVGIcon("svg/add-customer.svg",42,42));
        jButtonCustomeradd.setToolTipText("Add Customer");
        jButtonCustomeradd.setFocusable(false);
        jButtonCustomeradd.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jButtonCustomeradd.setMargin(new java.awt.Insets(2, 2, 2, 2));
        jButtonCustomeradd.setMaximumSize(new java.awt.Dimension(48, 48));
        jButtonCustomeradd.setMinimumSize(new java.awt.Dimension(48, 48));
        jButtonCustomeradd.setOpaque(true);
        jButtonCustomeradd.setPreferredSize(new java.awt.Dimension(48, 48));
        jButtonCustomeradd.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jButtonCustomeradd.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonCustomeraddActionPerformed(evt);
            }
        });
        jToolBar1.add(jButtonCustomeradd);
        ...
        jMenuItem4.setIcon(new FlatSVGIcon("svg/job-profile.svg",18,18));
        jMenuItem4.setText("Job Role");
        ...
        jMenuItem9.setIcon(new FlatSVGIcon("svg/camera.svg",18,18));
        jMenuItem9.setText("Open Camera");
        ...
        jMenuCustomer.setIcon(new FlatSVGIcon("svg/customer.svg",18,18));
        jMenuCustomer.setText("Customer");

        jMenuItem10.setIcon(new FlatSVGIcon("svg/sms.svg",18,18));
        jMenuItem10.setText("Send Message");
        jMenuItem10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem10ActionPerformed(evt);
            }
        });
        jMenuCustomer.add(jMenuItem10);

        jMenuItem12.setIcon(new FlatSVGIcon("svg/add-user.svg",18,18));
...
//            //Invoice set input
    ...
    private void jMenuItem9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem9ActionPerformed
        ...
        JWebCamOpen a = new JWebCamOpen(this, true);
        a.setVisible(true);
    ...
    private void jMenuItem10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem10ActionPerformed
        // TODO add your handling code here:
        JDialogSendMessage b = new JDialogSendMessage();
        b.setVisible(true);
    ...
    private void quitApp() {
        try {
            int reply = JOptionPane.showConfirmDialog(this,
                    ...
                    "SAHAN POS - Exit", JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE);
...
//        JButton
    ...
    private void logOut() {
        ...
        jMenuSystem.setText("Sahan Cafe");
...
//        JButton
    ...
    class ActionListenerHandler implements ActionListener {
        ...
        public ActionListenerHandler(ArrayList<Category> categoryList, JFrameHome jFrameHome) {
            this.categoryList = categoryList;
            this.jFrameHome = jFrameHome;
        }

        public ActionListenerHandler(LinkedList<Menu> menuList, JFrameHome jFrameHome) {
            this.menuList = menuList;
            this.jFrameHome = jFrameHome;
        }

        public ActionListenerHandler(JButton jButton, LinkedList<TodaysMenu> motdList, JFrameHome jFrameHome) {
...
//                    JFrameHome p = new JFrameHome(c,jFrameHome);
                        selectTodaysMenu(c.getId());
                        revalidate();
                    }
                }
...
//                     JFrameHome p = new JFrameHome(motd);
    ...
    private void loginRole() {
        ...
        if (role.toString().equals("ADMIN")) {
            ...
            jButtonSale.setVisible(true);
            jButtonPrint.setVisible(true);
            jButtonInvoice.setVisible(true);
            jButtonUpdatePrice.setVisible(true);
            jMenuCustomer.setVisible(true);
        } else if (role.equals("USER")) {
            jMenuManage.setVisible(false);
            jMenuSettings.setVisible(false);
            jButtonSale.setVisible(false);
            jButtonPrint.setVisible(false);
            jButtonInvoice.setVisible(false);
            jButtonUpdatePrice.setVisible(false);
            jMenuCustomer.setVisible(false);
        }
    }
}
