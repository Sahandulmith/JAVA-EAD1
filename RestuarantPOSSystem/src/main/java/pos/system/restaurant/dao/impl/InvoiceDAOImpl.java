...
import pos.system.restaurant.dao.InvoiceDAO;
...
//            closeConnection();
    ...
    public ArrayList<pos.system.restaurant.model.Invoice> getSalesUser(Long userId, Long startId, Long endId) {
        ArrayList<pos.system.restaurant.model.Invoice> list = new ArrayList<>();
        try {
            String query = "SELECT \n"
                    + "    USER_ACCOUNT.SURNAME, \n"
                    + "    USER_ACCOUNT.FIRSTNAME, \n"
            ...
            ResultSet rs = st.executeQuery(query);
            while (rs.next()) {
                pos.system.restaurant.model.Invoice i = new pos.system.restaurant.model.Invoice();
