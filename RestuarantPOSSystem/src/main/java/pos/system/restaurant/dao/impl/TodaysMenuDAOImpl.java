...
import pos.system.restaurant.dao.TodaysMenuDAO;
...
//            ps.setLong(2, category.getId());
    ...
    public ArrayList<TodaysMenu> selectTodaysMenu() {
        ArrayList<pos.system.restaurant.model.TodaysMenu> list = new ArrayList<>();
        try {
            String query = """
                           SELECT 
                              MENU.ID, 
            ...
            while (rs.next()) {
                pos.system.restaurant.model.TodaysMenu tm = new TodaysMenu();
                pos.system.restaurant.model.Category c = new pos.system.restaurant.model.Category();
                pos.system.restaurant.model.Menu m = new pos.system.restaurant.model.Menu();
...
//            closeConnection();
    ...
    @Override
    public ArrayList<pos.system.restaurant.model.TodaysMenu> getMenuList() {
        ArrayList<pos.system.restaurant.model.TodaysMenu> list = new ArrayList<>();
        try {
            String query = """
                           SELECT 
    ...
    @Override
    public void addMenuOfTheDay(pos.system.restaurant.model.Menu menu) {
        try {
            getDBConn();
...
//            c.closeConnection();
    ...
    public LinkedList<pos.system.restaurant.model.TodaysMenu> getMenuByCategoryIdMenuId(Long id) {
        LinkedList<pos.system.restaurant.model.TodaysMenu> list = new LinkedList<>();
        try {
            String query = "SELECT \n"
                    + "    TODAYS_MENU.ID,\n"
            ...
            ResultSet rs = st.executeQuery(query);
            while (rs.next()) {
                pos.system.restaurant.model.TodaysMenu tm = new pos.system.restaurant.model.TodaysMenu();
                pos.system.restaurant.model.Menu menu = new pos.system.restaurant.model.Menu();
